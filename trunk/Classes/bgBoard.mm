...
{
	{
		...
		CGRectMake(BOARD_WIDTH - BORDER_WIDTH - POINT_WIDTH, BOARD_HEIGHT - BORDER_HEIGHT, POINT_WIDTH, 5 * CHEQUER_HEIGHT),
		CGRectMake(BOARD_WIDTH - BORDER_WIDTH - POINT_WIDTH, BORDER_HEIGHT + POINT_HEIGHT, POINT_WIDTH, 5 * CHEQUER_HEIGHT),
	},
	{
